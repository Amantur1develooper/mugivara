...
urlpatterns = [
    ...
    path("<slug:slug>/room/<int:room_id>/menu/",      views.karaoke_room_menu,  name="karaoke_room_menu"),
    path("<slug:slug>/menu/order/",                   views.karaoke_menu_order, name="karaoke_menu_order"),
